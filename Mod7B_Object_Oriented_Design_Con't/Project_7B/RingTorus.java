...
public class RingTorus implements Comparable<RingTorus> {
   ...
   */
   ...
   /**
   * getLabel creates a new label for the RingTorus.
   *
   ...
   */
   ...
   /**
   * getLargeRadius creates a new large radius for the RingTorus.
   *
   ...
   */
   ...
   /**
   * getsmallRadius creates a new small radius for the RingTorus.
   *
   ...
   */
   ...
   /**
   * diameter creates a new diameter for the RingTorus.
   *
   ...
   */
   ...
   /**
   * surfaceArea creates a new surface area for the RingTorus.
   *
   ...
   */
   ...
   /**
   * volume creates a new volume for the RingTorus.
   * 
   * @return The calculation for the new surface area.
   */
   ...
   */
   ...
   /**
   * getCount creates an int representing the static count field.
   *
   ...
   */
   ...
   /**
   * equals creates a new RingTorus object and returns false if the object
   * is not a RingTorus and returns the field values if not false.
   *
   * @param obj The new RingTorus object.
   * @return A boolean false if not a RingTorus and field values if not false.
   */
   ...
   /**
   * hashCode creates an int and is required for the equals method above.
   *
